...
class ResponseUnReservedSchema(BaseModel):
    """
    ResponseUnReservedSchema
    """ # noqa: E501
    success: Optional[StrictBool] = None
    return_code: Optional[StrictStr] = Field(default=None, description="Result code if failed. In case of successful request: value is null")
    ...
    used_store: Optional[ResponseReservedSchemaUsedStore] = None
    bill_number: Optional[StrictStr] = Field(default=None, description="Bill number")
    data: Optional[List[ResponseUnReservedSchemaDataInner]] = Field(default=None, description="Detail items of voucher, if result is failed, response will return the first voucher code which is invalid")
    __properties: ClassVar[List[str]] = ["success", "return_code", "message_en", "message_vi", "used_store", "bill_number", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "used_store": ResponseReservedSchemaUsedStore.from_dict(obj["used_store"]) if obj.get("used_store") is not None else None,
            "bill_number": obj.get("bill_number"),
            "data": [ResponseUnReservedSchemaDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
