...
class ResponseCheckMultipleSchemaDataInnerRedemptions(BaseModel):
    """
    ...
    used_store: Optional[ResponseCheckMultipleSchemaDataInnerRedemptionsUsedStore] = None
    ...
    bill_number: Optional[StrictStr] = Field(default=None, description="Bill number for which voucher used/reserved")
    __properties: ClassVar[List[str]] = ["redeem_sku_codes", "redemption_value", "used_store", "used_date", "bill_number"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "used_store": ResponseCheckMultipleSchemaDataInnerRedemptionsUsedStore.from_dict(obj["used_store"]) if obj.get("used_store") is not None else None,
