...
class ResponseMarkUseMultipleSchemaDataInner(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "redemptions": ResponseMarkUseMultipleSchemaDataInnerRedemptions.from_dict(obj["redemptions"]) if obj.get("redemptions") is not None else None
        })
        return _obj
