...
class ResponseMarkUseMultipleSchema(BaseModel):
    """
    ...
    data: Optional[List[ResponseMarkUseMultipleSchemaDataInner]] = Field(default=None, description="Detail items of voucher, if result is failed, response will return the first voucher code which is invalid")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [ResponseMarkUseMultipleSchemaDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
