...
class ResponseMarkUseMultipleSchemaDataInnerRedemptions(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["redeem_sku_codes", "redemption_value", "used_store", "used_date"]
