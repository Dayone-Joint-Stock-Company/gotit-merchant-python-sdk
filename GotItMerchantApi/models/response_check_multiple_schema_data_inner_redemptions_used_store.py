...
class ResponseCheckMultipleSchemaDataInnerRedemptionsUsedStore(BaseModel):
    """
    ResponseCheckMultipleSchemaDataInnerRedemptionsUsedStore
    """ # noqa: E501
    name_vi: Optional[StrictStr] = Field(default=None, description="Store name in Vietnamese")
    name_en: Optional[StrictStr] = Field(default=None, description="Store name in English")
    __properties: ClassVar[List[str]] = ["name_vi", "name_en"]
