...
class ResponseCheckMultipleSchemaDataInner(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "conditions": ResponseCheckMultipleSchemaDataInnerConditions.from_dict(obj["conditions"]) if obj.get("conditions") is not None else None,
            "redemptions": ResponseCheckMultipleSchemaDataInnerRedemptions.from_dict(obj["redemptions"]) if obj.get("redemptions") is not None else None
        })
        return _obj
