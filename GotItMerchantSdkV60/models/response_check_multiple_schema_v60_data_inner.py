...
class ResponseCheckMultipleSchemaV60DataInner(BaseModel):
    """
    ...
    used_store: Optional[ResponseCheckMultipleSchemaV60DataInnerUsedStore] = None
    ...
    __properties: ClassVar[List[str]] = ["code", "product", "state", "used_date", "expiry_date", "cancel_date", "used_store", "bill_number", "voucher_type", "skus_condition_vi", "skus_condition_en", "redeem_sku", "redeemable_skus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "used_store": ResponseCheckMultipleSchemaV60DataInnerUsedStore.from_dict(obj["used_store"]) if obj.get("used_store") is not None else None,
