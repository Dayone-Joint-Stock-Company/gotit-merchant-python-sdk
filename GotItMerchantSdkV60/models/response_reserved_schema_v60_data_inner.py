...
class ResponseReservedSchemaV60DataInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["code", "voucher_type", "skus_condition_vi", "skus_condition_en", "redeem_sku", "redeemable_skus"]
