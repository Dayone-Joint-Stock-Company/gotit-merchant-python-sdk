...
class ResponseCheckMultipleSchemaV60DataInnerRedeemSku(BaseModel):
    """
    ResponseCheckMultipleSchemaV60DataInnerRedeemSku
    """ # noqa: E501
    redeem_sku_codes: Optional[List[ResponseCheckMultipleSchemaV60DataInnerRedeemSkuRedeemSkuCodesInner]] = Field(default=None, description="Contains redeemed SKU information")
    sku_redemption_value: Optional[StrictInt] = Field(default=None, description="Actual redemption value of voucher type = redeemable_sku")
    __properties: ClassVar[List[str]] = ["redeem_sku_codes", "sku_redemption_value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "redeem_sku_codes": [ResponseCheckMultipleSchemaV60DataInnerRedeemSkuRedeemSkuCodesInner.from_dict(_item) for _item in obj["redeem_sku_codes"]] if obj.get("redeem_sku_codes") is not None else None,
            "sku_redemption_value": obj.get("sku_redemption_value")
        })
        return _obj
