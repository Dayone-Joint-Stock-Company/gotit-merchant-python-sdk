...
class ResponseUnReservedSchemaV60(BaseModel):
    """
    ...
    used_store: Optional[ResponseReservedSchemaV60UsedStore] = None
    bill_number: Optional[StrictStr] = Field(default=None, description="Bill number")
    data: Optional[List[ResponseReservedSchemaV60DataInner]] = Field(default=None, description="Detail items of voucher, if result is failed, response will return the first voucher code which is invalid")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "used_store": ResponseReservedSchemaV60UsedStore.from_dict(obj["used_store"]) if obj.get("used_store") is not None else None,
            "bill_number": obj.get("bill_number"),
            "data": [ResponseReservedSchemaV60DataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
