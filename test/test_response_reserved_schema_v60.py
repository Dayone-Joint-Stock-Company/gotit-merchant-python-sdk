...
class TestResponseReservedSchemaV60(unittest.TestCase):
    """ResponseReservedSchemaV60 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ResponseReservedSchemaV60:
        """Test ResponseReservedSchemaV60
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResponseReservedSchemaV60`
        """
        model = ResponseReservedSchemaV60()
        if include_optional:
            return ResponseReservedSchemaV60(
                success = True,
                return_code = '',
    ...
    def testResponseReservedSchemaV60(self):
        """Test ResponseReservedSchemaV60"""
